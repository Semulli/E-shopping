...
var useEnhancedEffect = typeof window !== "undefined" ? React20.useLayoutEffect : React20.useEffect;
...
function useFloating(options) {
  ...
  const [latestMiddleware, setLatestMiddleware] = React52.useState(middleware);
  if (!deepEqual(latestMiddleware, middleware)) {
    setLatestMiddleware(middleware);
  }
  const [_reference, _setReference] = React52.useState(null);
  const [_floating, _setFloating] = React52.useState(null);
  const setReference = React52.useCallback((node) => {
    if (node !== referenceRef.current) {
      referenceRef.current = node;
      _setReference(node);
    }
  }, []);
  const setFloating = React52.useCallback((node) => {
...
var Portal = React53.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef2(React53.isValidElement(children) ? getReactElementRef2(children) : null, forwardedRef);
  useEnhancedEffect_default2(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React53.isValidElement(children)) {
      ...
      return React53.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime13.jsx)(React53.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime13.jsx)(React53.Fragment, {
...
var TransitionContext = React54.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React55.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React56.useState(true);
  const hasPendingExitTransition = React56.useRef(false);
  const registeredTransitions = React56.useRef(0);
  const [hasTransition, setHasTransition] = React56.useState(false);
  const previousRequestEnter = React56.useRef(requestEnter);
  React56.useEffect(() => {
  ...
  const handleExited = React56.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React56.useCallback(() => {
...
var PopupContext = React57.createContext(null);
if (true) {
...
var Popup = React58.forwardRef(function Popup2(props, forwardedRef) {
  ...
  const popupContextValue = React58.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React60.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React61.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
function useMenuItem(params) {
  ...
  const itemMetadata = React62.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React62.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useMenuItemContextStabilizer(id) {
  const listContext = React63.useContext(ListContext);
  if (!listContext) {
  ...
  const localGetItemState = React63.useCallback((itemValue) => {
    if (itemValue !== itemId) {
  ...
  const localContextValue = React63.useMemo(() => ({
    dispatch,
...
var InnerMenuItem = React64.memo(React64.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React64.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
function useModal(parameters) {
  ...
  const isTopModal = React65.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
var Modal = React66.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
  ...
  return (0, import_jsx_runtime18.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime19.jsxs)(Root, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime18.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime18.jsx)(FocusTrap, {
        ...
        open,
        children: React66.cloneElement(children, childProps)
      })]
    }))
  });
});
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(React67.Fragment, {
...
function clampStepwise(val, min2 = Number.MIN_SAFE_INTEGER, max2 = Number.MAX_SAFE_INTEGER, stepProp = NaN) {
  if (Number.isNaN(stepProp)) {
    return clamp_default2(val, min2, max2);
  }
  const step = stepProp || 1;
  const remainder = val % step;
  const positivity = Math.sign(remainder);
  if (Math.abs(remainder) > step / 2) {
    return clamp_default2(val + positivity * (step - Math.abs(remainder)), min2, max2);
  }
  return clamp_default2(val - positivity * Math.abs(remainder), min2, max2);
}
...
function useOptionContextStabilizer(value) {
  const listContext = React72.useContext(ListContext);
  if (!listContext) {
...
var PopperTooltip = React74.forwardRef(function PopperTooltip2(props, forwardedRef) {
  var _slots$root;
  const {
    anchorEl,
    children,
  ...
  const handlePopperRefRef = React74.useRef(handlePopperRef);
  useEnhancedEffect_default2(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React74.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React74.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React74.useState(resolveAnchorEl(anchorEl));
  React74.useEffect(() => {
...
var Popper = React74.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
  ...
  if (containerProp) {
    ...
    container = resolvedAnchorEl && isHTMLElement2(resolvedAnchorEl) ? ownerDocument2(resolvedAnchorEl).body : ownerDocument2(null).body;
  }
...
function useSelect(props) {
  ...
  const optionValues = React75.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React75.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React75.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = getOptionByValue(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [getOptionByValue]);
  const stringifyOption = React75.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React75.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React75.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React75.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React75.useCallback((event, newValue) => {
    onHighlightChange == null || onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React75.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const getItemDomElement = React75.useCallback((itemId) => {
    var _subitems$get$ref$cur, _subitems$get;
    if (itemId == null) {
      return null;
    }
  ...
  const useListParameters = {
    ...
    onHighlightChange: handleHighlightChange,
    onStateChange: handleStateChange,
    reducerActionContext: React75.useMemo(() => ({
      multiple
    }), [multiple]),
    items: optionValues,
  ...
  const isInitiallyOpen = React75.useRef(open);
  useEnhancedEffect_default2(() => {
  ...
  const getOptionMetadata = React75.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React75.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
function SelectProvider(props) {
  ...
  const listContextValue = React76.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime28.jsx)(React77.Fragment, {
...
var Select = React77.forwardRef(function Select2(props, forwardedRef) {
  ...
  const [buttonDefined, setButtonDefined] = React77.useState(false);
  ...
  const handleButtonRefChange = React77.useCallback((element) => {
  ...
  return (0, import_jsx_runtime29.jsxs)(React77.Fragment, {
...
function useSlider(parameters) {
  ...
  const touchId = React78.useRef(void 0);
  const [active, setActive] = React78.useState(-1);
  const [open, setOpen] = React78.useState(-1);
  const [dragging, setDragging] = React78.useState(false);
  const moveCount = React78.useRef(0);
  ...
  values2 = values2.map((value) => value == null ? min2 : clamp_default2(value, min2, max2));
  ...
  const [focusedThumbIndex, setFocusedThumbIndex] = React78.useState(-1);
  const sliderRef = React78.useRef(null);
  ...
  const changeValue = (event, valueInput) => {
    ...
    newValue = clamp_default2(newValue, min2, max2);
    if (range) {
      if (disableSwap) {
  ...
  const previousIndex = React78.useRef(void 0);
  ...
  const stopListening = React78.useCallback(() => {
    const doc = ownerDocument2(sliderRef.current);
...
var Slider = React79.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime31.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime30.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime30.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime31.jsxs)(React79.Fragment, {
...
var Snackbar = React81.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React83.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React84.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React85.forwardRef(function TablePagination2(props, forwardedRef) {
...
function useTabs(parameters) {
  ...
  const onSelected = React86.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React86.useRef(() => void 0);
  const getTabPanelId = React86.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React86.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React86.useCallback((lookupFunction) => {
...
var TabsContext = React87.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React87.useContext(TabsContext);
  if (context == null) {
...
function TabsProvider(props) {
  ...
  const compoundComponentContextValue = React88.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
  const tabsContextValue = React88.useMemo(() => ({
    direction,
    getTabId,
    getTabPanelId,
    onSelected,
...
var Tabs = React89.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React90.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React91.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React92.useCallback((tabValue) => {
    var _subitems$get;
    return (_subitems$get = subitems.get(tabValue)) == null ? void 0 : _subitems$get.id;
  }, [subitems]);
  registerTabIdLookup(tabIdLookup);
  const subitemKeys = React92.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getTabElement = React92.useCallback((tabValue) => {
  ...
  const handleChange = React92.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React92.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React92.useCallback((item) => {
  ...
  const {
    ...
    reducerActionContext: React92.useMemo(() => ({
  ...
  const contextValue = React92.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function TabsListProvider(props) {
  ...
  const listContextValue = React93.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
  const compoundComponentContextValue = React93.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
...
var TabsList = React94.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTab(parameters) {
  ...
  const tabMetadata = React95.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var Tab = React96.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
  ...
  const tabRef = React96.useRef(null);
...
var TextareaAutosize = React97.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const {
    current: isControlled
  } = React97.useRef(value != null);
  const inputRef = React97.useRef(null);
  const handleRef = useForkRef2(forwardedRef, inputRef);
  const heightRef = React97.useRef(null);
  const shadowRef = React97.useRef(null);
  const calculateTextareaStyles = React97.useCallback(() => {
  ...
  const syncHeight = React97.useCallback(() => {
  ...
  return (0, import_jsx_runtime46.jsxs)(React97.Fragment, {
...
function CssAnimation(props) {
  ...
  const hasExited = React98.useRef(true);
  React98.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React98.useCallback((event) => {
...
var CssTransition = React99.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React99.useState(false);
  React99.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React99.useCallback((event) => {
...
function useTheme(defaultTheme5 = null) {
  const contextTheme = React103.useContext(ThemeContext);
...
function createBox(options = {}) {
  ...
  const Box2 = React105.forwardRef(function Box3(inProps, ref) {
...
var ThemeContext2 = React107.createContext(null);
if (true) {
...
function useTheme3() {
  const theme = React108.useContext(ThemeContext_default);
  if (true) {
    React108.useDebugValue(theme);
  }
  return theme;
}
...
var RtlContext = React110.createContext();
...
var PropsContext = React111.createContext(void 0);
...
var useUtilityClasses24 = (ownerState) => {
  ...
  const slots = {
    root: ["root", determinate && "determinate", color2 && `color${capitalize(color2)}`, variant && `variant${capitalize(variant)}`, size3 && `size${capitalize(size3)}`],
    svg: ["svg"],
    track: ["track"],
    progress: ["progress"]
  };
...
var CircularProgress = React119.forwardRef(function CircularProgress2(inProps, ref) {
  ...
  return (0, import_jsx_runtime64.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime64.jsxs)(SlotSvg, _extends({}, svgProps, {
      children: [(0, import_jsx_runtime63.jsx)(SlotTrack, _extends({}, trackProps)), (0, import_jsx_runtime63.jsx)(SlotProgress, _extends({}, progressProps))]
    })), children]
  }));
});
